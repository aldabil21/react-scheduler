...
| events                  | Array of ProcessedEvent. <br>_Default_: [] <br> type ProcessedEvent = {<br>event_id: number or string;<br>title: string;<br>start: Date;<br>end: Date;<br>disabled?: boolean;<br>color?: string;<br>editable?: boolean;<br>deletable?: boolean;<br>}                                                                                                                                                                      |
