...
| day                     | Object. Month view props. <br> _default_: <pre>{<br>startHour: 9, <br>endHour: 17, <br>step: 60<br> }</pre>                                                                                                                                                                                    | selectedDate | Date. Initial selected date. <br>_Default_: new Date() |     |
| showAddDialog           | Boolean Toggle to show/ hide the add event dialog                                                                                                                                                                                                                                              |
