...
| Prop                     | Value                                                                                                                                                                                                                                                                                                                                                                                                                                       |
|--------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| dateAdapter (_required_) | `AdapterDateFns` of date-fns,you can control the date-fns version <br/>If you are using date-fns v3, you must pass the `AdapterDateFns` from `@mui/x-date-pickers/AdapterDateFnsV3`<br/>_Default_: `AdapterDateFns` from date-fns v2                                                                                                                                                                                                        |
